...
function box() {
    ...
    <td id="newname+'${i}'">${apidata[i].name}</td>
    <td id="newemail+'${i}'">${apidata[i].email}</td>
    <td align="center"><button onclick="update('${apidata[i].email}')">update</button></td>
    <td align="center"><button onclick="deletes('${apidata[i].email}')">delete</button></td>
    <tr>`
        }
